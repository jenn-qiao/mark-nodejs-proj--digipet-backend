...
exports.isIgnoreDigipetTen = exports.updateDigipetBounded = exports.setDigipet = exports.getDigipet = exports._userDigipet = exports.INITIAL_DIGIPET = void 0;
...
function isIgnoreDigipetTen(digipetKey, netUpdate) {
    const digipetData = getDigipet(); // is a shallow copy
    if (digipetData) {
        const valueToBound = digipetData[digipetKey] + netUpdate;
        if (valueToBound > 10) {
...
exports.isIgnoreDigipetTen = isIgnoreDigipetTen;
